...
- EDA relacional sobre p95, RPS y presencia de errores.
- Cut-off 0,35 seleccionado mediante función de costo configurable.
- Matriz de confusión y acciones actualizadas con el umbral seleccionado.
- Validación cruzada agrupada en cinco folds y métricas por segmento.
- Separación explícita entre validación offline completada y muestra `upgrade` pendiente.
