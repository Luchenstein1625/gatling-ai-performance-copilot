  ...
  if (type === "data-quality")
    return (
      <div className="rubric-data-layout">
        ...
        <div className="quality-findings"><b>Relaciones observadas</b><span>RPS mediana: 0,18 not_applies frente a 0,63 applies</span><span>24,0 % de not_applies registra errores; applies 0 %</span><span>p95 mediana: 1.334 ms frente a 1.231 ms</span></div>
        <p className="takeaway"><strong>Conclusión EDA:</strong> RPS, p95 y errores separan las clases observadas, pero se excluyen del input para evitar fuga; apdex y rating tampoco son utilizables.</p>
      </div>
    );
  ...
  if (type === "sensitivity")
    return (
      <div className="overfit-layout">
        ...
        <div className="gap-reading"><small>LECTURA</small><b>Brecha de ≈ 11 puntos</b><p>Existe sobreajuste moderado; por eso se agregó validación cruzada agrupada por Build_Id.</p><div><strong>5-fold agrupado</strong><span>F1 medio 0,8049 · rango 0,7682–0,8363</span></div><div><strong>Límite</strong><span>Etiquetas derivadas de evidencia, aún sin validación experta independiente</span></div></div>
  ...
  if (type === "results")
    return (
      <div className="layered-layout">
        ...
        <div className="decision-distribution"><span>HOLDOUT · 1.330 · CUT-OFF 0,35</span><div className="review"><b>895</b><strong>review</strong><p>67,3 % · conserva configuración</p></div><div><b>217</b><strong>maintain</strong><p>16,3 % · mantiene cuadrante</p></div><div className="upgrade"><b>218</b><strong>upgrade</strong><p>16,4 % · candidato controlado</p></div></div>
  ...
  if (type === "case")
    return (
      <div className="cost-sensitivity-layout">
        <div className="cost-matrix-v2"><div className="head"><b>Real \ Predicho</b><b>not_applies</b><b>applies</b></div><div><strong>not_applies</strong><span className="good">665 · revisión correcta</span><span className="critical">90 · riesgo de aprobación</span></div><div><strong>applies</strong><span>230 · revisión adicional</span><span className="good">345 · aprobación correcta</span></div></div>
        ...
        <div className="threshold-note"><b>Cut-off seleccionado: 0,35</b><span>Recall 0,8808 · F1 0,8061 · 90 falsos applies. Costos supuestos: falso applies 10, falso not_applies 2 y review 1.</span></div>
        <p className="takeaway"><strong>Recomendación:</strong> minimiza 2.255 unidades de costo esperado; los costos monetarios reales se recalibrarán con el piloto.</p>
      </div>
    );
  ...
  if (type === "impact")
    return (
      <div className="impact-layout economic-impact">
        ...
        <Arrow />
        <div className="impact-after"><small>RECOMENDACIÓN ÓPTIMA</small><b>Cut-off 0,35</b><p>Reduce falsos applies de 221 a 90, a cambio de más revisiones humanas controladas.</p></div>
  ...
  if (type === "implementation")
    return (
      <div className="validation-layout">
        ...
        <div className="future-work"><b>Estado de validación</b><span>Offline + 5-fold agrupado: completado</span><span>Métricas por pilar/componente: completadas</span><span>Etiquetas expertas: pendientes</span><span>Muestra upgrade en Gatling: pendiente</span></div>
    ...
    <div className="closing-layout">
      ...
      <div className="next">
        ...
        <ul>
          ...
          <li>Cut-off optimizado y 5-fold agrupado</li>
