  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    header {
      ...
      padding: 10px 18px; background: linear-gradient(180deg, rgba(0,0,0,.45), transparent);
    }
    header .title { font-weight: 600; letter-spacing: .3px; color: #d4d4d8; }
    header .count { color: var(--muted); font-size: 14px; }
    .stage {
      position: relative; width: 100vw; height: 100vh; border-radius: 0;
      perspective: 1200px; overflow: hidden; /* hide any peeking faces */
    }
    .shadow {
      position: absolute; left: 50%; transform: translateX(-50%);
      bottom: 20px; width: 50%; height: 60px; filter: blur(28px);
    ...
    .face {
      position: absolute; left: -1.5%; right: -1.5%; top: -1.5%; bottom: -1.5%; border-radius: 12px;
    ...
    .controls {
      position: absolute; inset: 0; display: flex; align-items: center; justify-content: space-between; pointer-events: none; z-index: 15;
    }
    .btn {
    ...
    .edge-mask { position: absolute; top: 0; bottom: 0; width: min(14vw, 160px); z-index: 9; pointer-events: none; }
    .edge-mask.left { left: 0; background: linear-gradient(90deg, var(--bg), transparent 70%); }
    .edge-mask.right { right: 0; background: linear-gradient(270deg, var(--bg), transparent 70%); }
    ...
    .footer-actions { position: fixed; left: 50%; transform: translateX(-50%); bottom: 18px; display: flex; gap: 10px; align-items: center; justify-content: center; z-index: 20; }
    .button {
