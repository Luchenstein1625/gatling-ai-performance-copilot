...
## Definición
Variante de clustering diseñada para variables categóricas.

## Aplicación al Capstone
Agrupar microservicios según atributos categóricos como criticidad o dominio.

## Ventajas
Trabaja directamente con categorías.

## Limitaciones
Depende de la representación y del número de grupos.
