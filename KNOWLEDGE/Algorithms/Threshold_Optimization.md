...
## Definición
Selección del umbral de decisión según una métrica objetivo.

## Aplicación al Capstone
Ajustar sensibilidad para cuadrantes críticos o clases desbalanceadas.

## Ventajas
Permite alinear el modelo con el costo del error.

## Limitaciones
Puede sobreajustarse si se optimiza sobre el conjunto de prueba.
