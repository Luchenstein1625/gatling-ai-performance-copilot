...
## Definición
Algoritmo de clustering basado en densidad que identifica grupos y ruido.

## Aplicación al Capstone
Detectar perfiles y ejecuciones anómalas sin fijar el número de grupos.

## Ventajas
Reconoce formas arbitrarias y outliers.

## Limitaciones
Sensible a epsilon, min_samples y escalamiento.
