...
## Definición
Algoritmo para descubrir conjuntos frecuentes y reglas de asociación.

## Aplicación al Capstone
Explorar combinaciones de condiciones relacionadas con fallas o degradación.

## Ventajas
Produce reglas legibles.

## Limitaciones
Puede generar demasiadas reglas y requiere buen soporte/confianza.
