...
## Definición
Búsqueda exhaustiva sobre combinaciones de hiperparámetros.

## Aplicación al Capstone
Ajustar modelos candidatos con un espacio acotado.

## Ventajas
Reproducible y fácil de explicar.

## Limitaciones
Costoso cuando el espacio es grande.
