...
Detectar ejecuciones históricas atípicas antes de entrenar el recomendador.

## Ventajas
Escalable y útil en datos tabulares.

## Limitaciones
Los resultados dependen del nivel de contaminación esperado.
