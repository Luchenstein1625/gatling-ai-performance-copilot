...
## Definición
Modelo supervisado que divide los datos mediante reglas jerárquicas.

## Aplicación al Capstone
Clasificar cuadrantes con reglas interpretables.

## Ventajas
Alta explicabilidad y fácil comunicación con especialistas.

## Limitaciones
Puede sobreajustar y ser inestable ante pequeños cambios.
