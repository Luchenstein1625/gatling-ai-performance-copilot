...
## Definición
Clustering híbrido para variables numéricas y categóricas.

## Aplicación al Capstone
Combinar métricas de rendimiento y metadatos del microservicio.

## Ventajas
Adecuado para datos mixtos.

## Limitaciones
Requiere balancear correctamente las distancias numéricas y categóricas.
