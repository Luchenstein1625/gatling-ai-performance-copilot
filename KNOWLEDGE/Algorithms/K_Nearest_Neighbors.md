...
## Definición
Algoritmo que predice usando los casos más cercanos según una métrica de distancia.

## Aplicación al Capstone
Recomendar cuadrante usando microservicios o ejecuciones históricas similares.

## Ventajas
Simple, intuitivo y útil como baseline de similitud.

## Limitaciones
Sensible a escala, ruido, variables irrelevantes y elección de k.
