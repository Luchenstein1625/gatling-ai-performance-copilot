...
## Definición
Algoritmo no supervisado que agrupa observaciones alrededor de centroides.

## Aplicación al Capstone
Descubrir perfiles de microservicios cuando no existen etiquetas.

## Ventajas
Simple, rápido y útil para exploración.

## Limitaciones
Requiere definir k y asume grupos aproximadamente esféricos.
